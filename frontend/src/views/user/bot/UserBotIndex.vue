...
export default {
    ...
    setup() {
        ...
        const refresh_bots = () => {
            $.ajax({
                url: 'http://120.46.137.137:3000/api/user/bot/all',
                type: 'get',
                headers: {
        ...
        const add_bot = () => {
            $.ajax({
                url: 'http://120.46.137.137:3000/api/user/bot/add',
                type: 'post',
                headers: {
                    Authorization: 'Bearer ' + store.state.user.token,
                },
        ...
        const remove_bot = (bot) => {
            $.ajax({
                url: 'http://120.46.137.137:3000/api/user/bot/remove',
                type: 'post',
                headers: {
                    Authorization: 'Bearer ' + store.state.user.token,
                },
        ...
        const update_bot = (bot) => {
            $.ajax({
                url: 'http://120.46.137.137:3000/api/user/bot/update',
                type: 'post',
                headers: {
                    Authorization: 'Bearer ' + store.state.user.token,
                },
